...
// reset
export const RESET_JOB_STATUS_SUCCESS = 'RESET_JOB_STATUS_SUCCESS';
// update
...
export const UPDATE_JOB_DEFINITION = 'UPDATE_JOB_DEFINITION';

// Delete job session
export const DELETE_INTERACTIVE_JOB_SESSION_SUCCESS =
    'DELETE_INTERACTIVE_JOB_SESSION_SUCCESS';
export const DELETE_INTERACTIVE_JOB_SESSION_FAIL =
    'DELETE_INTERACTIVE_JOB_SESSION_FAIL';

// Delete job session
export const UPDATE_INTERACTIVE_JOB_SESSION_SUCCESS =
    'UPDATE_INTERACTIVE_SESSION_SUCCESS';
export const UPDATE_INTERACTIVE_JOB_SESSION_FAIL = 'UPDATE_INTERACTIVE_SESSION_FAIL';

// Clear interactive data
export const CLEAR_INTERACTIVE_DATA = 'CLEAR_INTERACTIVE_DATA';

// Set interactive data
export const SET_INTERACTIVE_DATA = 'SET_INTERACTIVE_DATA';

// Metadata
export const FETCH_JOB_METADATA_START = 'FETCH_JOB_METADATA_START';
export const FETCH_JOB_METADATA_SUCCESS = 'FETCH_JOB_METADATA_SUCCESS';
export const FETCH_JOB_METADATA_FAIL = 'FETCH_JOB_METADATA_FAIL';

// Session Event
export const INTERACTIVE_SESSION_EVENT_START = 'INTERACTIVE_SESSION_EVENT_START';
export const INTERACTIVE_SESSION_EVENT_SUCCESS = 'INTERACTIVE_SESSION_EVENT_SUCCESS';
export const INTERACTIVE_SESSION_EVENT_FAIL = 'INTERACTIVE_SESSION_EVENT_FAIL';
...
// reset
export const RESET_PIPELINE_STATUS_SUCCESS = 'RESET_PIPELINE_STATUS_SUCCESS';
// update
...
export const SET_STAGE_COPY = 'SET_STAGE_COPY';

// Utils
export const FETCH_CLUSTER_UTILS_START = 'FETCH_CLUSTER_UTILS_START';
export const FETCH_CLUSTER_UTILS_SUCCESS = 'FETCH_CLUSTER_UTILS_SUCCESS';
export const FETCH_CLUSTER_UTILS_FAIL = 'FETCH_CLUSTER_UTILS_FAIL';
