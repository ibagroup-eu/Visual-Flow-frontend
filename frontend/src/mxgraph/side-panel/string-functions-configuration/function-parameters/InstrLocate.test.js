...
import InstrLocateParameter from './InstrLocate';
import { TextField } from '@material-ui/core';

describe('InstrLocateParameter', () => {
    const init = (props = {}, returnProps = false) => {
        ...
        const wrapper = shallow(
            <InstrLocateParameter {...defaultProps} {...props} />
        );
    ...
    it('should handle TextField onChange prop', () => {
        ...
        expect(props.onChange).toHaveBeenCalledWith('option.substring', 'test');
        wrapper.setProps({
            state: {
                name: 'test',
                function: 'locate'
