    ...
    return (
        <>
            ...
            {inputValues.operation === READ && (
                <ParamsSwitchField
                    ableToEdit={ableToEdit}
                    label={t('jobDesigner:readConfiguration.wholetext')}
                    name="wholetext"
                    value={
                        inputValues.wholetext === undefined
                            ? undefined
                            : inputValues.wholetext === 'true'
                    }
