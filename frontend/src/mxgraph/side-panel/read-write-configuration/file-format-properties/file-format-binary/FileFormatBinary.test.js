...
describe('FileFormatBinary', () => {
    ...
    it('should render form in write mode', () => {
        ...
        expect(wrapper.find(FileFormatCommonFields).length).toEqual(1);
        expect(wrapper.find(SelectField).length).toEqual(0);
    });
});
