...
import useStyles from './WithColumnStage.Styles';
    ...
    return (
        ...
        >
            <JobStageTag className={classes.type}>
                {t(`jobDesigner:withColumnConfiguration.${stage.operationType}`)}
            </JobStageTag>
        </ConfiguredStageWithIcon>
    );
};

WithColumnStage.propTypes = {
    stage: PropTypes.object
};

export default WithColumnStage;
