...
process.env.GITLAB_APP_ID = 'GITLAB_APP_ID';
process.env.GITLAB_APP_SECRET = 'GITLAB_APP_SECRET';
process.env.STRATEGY_BASE_URL = 'https://strategy_base_url';
...
process.env.PLATFORM = 'DATABRICKS';
